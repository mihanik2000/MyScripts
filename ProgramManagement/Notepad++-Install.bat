...
set URLNotepad="http://download.notepad-plus-plus.org/repository/8.x/8.6/npp.8.6.Installer.exe"
set URLNotepad-x64="http://download.notepad-plus-plus.org/repository/8.x/8.6/npp.8.6.Installer.x64.exe"
